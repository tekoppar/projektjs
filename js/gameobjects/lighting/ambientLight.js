...
class AmbientLight extends Cobject {
	...
	constructor(position, color = new Color(243, 197, 47), attenuation = 100, intensity = 750.0, colorIntensity = 1.0, lightConstant = 600, lightLinear = 0.2, lightQuad = 0.4, drawScale = 1, lightFalloffType = LightFalloffType.InverseSquareLaw) {
		...
		/**@type {string} */ this.name = 'AmbientLight' + this.UID;
		/**@type {Color} */ this.color;
		this.SetColor(color);
		/**@type {number} */ this.attenuation = attenuation;
		/**@type {number} */ this.halfAttenuation = attenuation * 0.5;
		/**@type {number} */ this.intensity = intensity;
		/**@type {number} */ this.drawScale = drawScale;
		/**@type {number} */ this.colorIntensity = colorIntensity;
		/**@type {LightFalloffType} */ this.lightFalloffType = lightFalloffType;
		/**@type {number} */ this.constant = lightConstant;
		/**@type {number} */ this.linear = lightLinear;
		/**@type {number} */ this.quad = lightQuad;
		/**@type {ImageData} */ this.lightData;
		/**@type {ImageData} */ this.colorData;
		/**@type {BoxCollision} */ this.BoxCollision = new BoxCollision(
		...
		/** @type {LightingOperation} */ this.drawingOperation = new LightingOperation(this, position, CanvasDrawer.GCD.frameBuffer, this);
