...
/** @type {Object.<string, {atlas: string, animation: CAnimation, collision: Rectangle}>} */ let resourceSprites = {};
...
resourceSprites.coalLump = {atlas: 'ore', animation:new CAnimation('null', new Vector2D(0, 10), new Vector2D(0, 10), 32, 32, AnimationType.Single, 1), collision: new Rectangle(8, 0, 0, 0)};
