...
Props = Props.concat([
    ...
    new Rock('coalRock', new Vector2D(4.5 * 32, 24 * 32), undefined, 'coalRock', 0, new Vector4D(32, 32, 0, 0), 'coal', new Rectangle(13.5, 25, 64, 32)),
    new Rock('ironRock', new Vector2D(5.5 * 32, 24 * 32), undefined, 'ironRock', 0, new Vector4D(32, 32, 0, 0), 'iron', new Rectangle(13.5, 25, 64, 32)),
    new Rock('tinRock', new Vector2D(6.5 * 32, 24 * 32), undefined, 'tinRock', 0, new Vector4D(32, 32, 0, 0), 'tin', new Rectangle(13.5, 25, 64, 32)),
    new Rock('copperRock', new Vector2D(7.5 * 32, 24 * 32), undefined, 'copperRock', 0, new Vector4D(32, 32, 0, 0), 'copper', new Rectangle(13.5, 25, 64, 32)),
    new Rock('silverRock', new Vector2D(8.5 * 32, 24 * 32), undefined, 'silverRock', 0, new Vector4D(32, 32, 0, 0), 'silver', new Rectangle(13.5, 25, 64, 32)),
    new Rock('goldRock', new Vector2D(9.5 * 32, 24 * 32), undefined, 'goldRock', 0, new Vector4D(32, 32, 0, 0), 'gold', new Rectangle(13.5, 25, 64, 32)),
