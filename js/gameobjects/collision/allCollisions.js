...
AllBlockingCollisions.stoneSmelter = [new Vector2D(0, 64), new Vector2D(64, 64), new Vector2D(64, 96), new Vector2D(0, 96)];

AllCollisions.anvil = [new Vector2D(0, 0), new Vector2D(64, 0), new Vector2D(64, 32), new Vector2D(0, 32)];
AllBlockingCollisions.anvil = [new Vector2D(24, 14), new Vector2D(44, 14), new Vector2D(44, 32), new Vector2D(24, 32)];

AllCollisions.workbench = [new Vector2D(0, 0), new Vector2D(64, 0), new Vector2D(64, 64), new Vector2D(0, 64)];
AllBlockingCollisions.workbench = [new Vector2D(5, 32), new Vector2D(59, 32), new Vector2D(59, 64), new Vector2D(5, 64)];
...
AllBlockingCollisions.stoneCutter = [new Vector2D(9, 24), new Vector2D(53, 24), new Vector2D(53, 42), new Vector2D(9, 42), ];

AllCollisions.planningTable = [new Vector2D(0, 0), new Vector2D(64, 0), new Vector2D(64, 64), new Vector2D(0, 64)];
AllBlockingCollisions.planningTable = [new Vector2D(0, 32), new Vector2D(64, 32), new Vector2D(64, 64), new Vector2D(0, 64)];
