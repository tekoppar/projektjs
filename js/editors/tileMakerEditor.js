...
class TileMakerEditor {
    ...
    constructor() {
        ...
        /** @type {Number} */
        this.tileLayoutIndex = 0;

        /** @type {Array<Array<Array<Number>>>} */
        this.tileLayout = [];

        /** @type {Vector2D} */
        this.selectedGrid = new Vector2D(0, 0);
        ...
        this.openButton = /** @type {HTMLButtonElement} */ (document.getElementById('tilemaker-editor'));
