 ...
 */
class TileMaker {
	/** @type {TileMaker} */ static CustomTiles;
	...
	static GenerateCustomTiles() {
		...
		TileMaker.CustomTiles = {
			...
			stoneCutter: {
				name: 'stoneCutter',
				tiles: [
					new Tile(new Vector2D(0, 12), new Vector2D(10, 11), new Vector2D(32, 32), true, 'blacksmithsmelter', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(11, 11), new Vector2D(32, 32), true, 'blacksmithsmelter', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(10, 12), new Vector2D(32, 32), true, 'blacksmithsmelter', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(11, 12), new Vector2D(32, 32), true, 'blacksmithsmelter', 0, TileType.Prop, TileTerrain.Wood)
				],
				tileLayout: [
					[[0], [1]],
					[[2], [3]],
			...
			woodenFloor: {
				...
				tiles: [
					...
					new Tile(new Vector2D(0, 12), new Vector2D(11, 43), new Vector2D(32, 32), true, 'victorianmarket', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(13, 43), new Vector2D(32, 32), true, 'victorianmarket', 0, TileType.Prop, TileTerrain.Wood)
				],
				tileLayout: [
					[[0], [1]],
					[[2], [3]],
			...
			sawTable: {
				name: 'sawTable',
				tiles: [
					new Tile(new Vector2D(0, 12), new Vector2D(8, 5), new Vector2D(32, 32), true, 'woodshop', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(9, 5), new Vector2D(32, 32), true, 'woodshop', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(8, 6), new Vector2D(32, 32), true, 'woodshop', 0, TileType.Prop, TileTerrain.Wood),
					new Tile(new Vector2D(0, 12), new Vector2D(9, 6), new Vector2D(32, 32), true, 'woodshop', 0, TileType.Prop, TileTerrain.Wood)
				],
				tileLayout: [
					[[0], [1]],
					[[2], [3]],
