...
/** @type {Object.<string, CAnimation>} */ let smallAnimalAnimations = {
	...
	runLeft: new CAnimation('runLeft', new Vector2D(0, 1), new Vector2D(3, 1), 32, 32, AnimationType.Cycle, 6),
	...
	runRight: new CAnimation('runRight', new Vector2D(0, 3), new Vector2D(3, 3), 32, 32, AnimationType.Cycle, 6),
	...
	runDown: new CAnimation('runDown', new Vector2D(0, 2), new Vector2D(3, 2), 32, 32, AnimationType.Cycle, 6),
	...
	runUp: new CAnimation('runUp', new Vector2D(0, 0), new Vector2D(3, 0), 32, 32, AnimationType.Cycle, 6),
}
